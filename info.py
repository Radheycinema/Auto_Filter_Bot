...
API_ID = int(environ.get('API_ID', '27480623')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', '76746bb61cd52e2a0842def933534a10')  # API Hash from my.telegram.org
BOT_TOKEN = environ.get('BOT_TOKEN', "8373336639:AAFg8pdZKbNv59ReKa7omRLITJmyuaWBoAE")    # Bot token from @BotFather
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003099409176'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002988330517'))  # Bin channel id (make sure bot is admin)
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002740993075')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003030543088')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+80Map5FDHm81Mzc9')  # Support group link (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Radhey:Radhey@radhey.lxzme.mongodb.net/?retryWrites=true&w=majority&appName=Radhey
